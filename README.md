...
Ik wil mijn app het de gebruiker gemakkelijk maken, door bijvoorbeeld een overzichtelijke style te gebruiken, 
en de gebruiker duidelijk te vragen/zeggen wat te doen.

---Welk design ga ik gebruiken?---
Ik wil op mijn applicatie een scroll overzicht hebben van de spelers, (misschien nog met filters), en als je op de speler klikt,
komt er een detailed page popup die alle informatie van die speler laat zien.
